...
//  Usage:
//    phantom                   → Tor mode (default)
//    phantom --proxy=tor       → Tor SOCKS5 on 127.0.0.1:9050
//    phantom --proxy=i2p       → I2P HTTP proxy on 127.0.0.1:4444
//    phantom --proxy=none      → No proxy (direct)
//    phantom --proxy=socks5://user:pass@host:port  → Custom SOCKS5
//    phantom --proxy=chain://host:port → Tor + custom SOCKS5
// ─────────────────────────────────────────────────────────────────────────────
